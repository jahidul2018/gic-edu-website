...
@section('frontpage_content')
    ...
    <div class="wrapper white-wrapper">
        <div class="container inner">
          <h2 class="section-title mb-40 text-center mt-20" style=" ">University Admission</h2>
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <p class="display-4">The selection of a college/university has many long-term impacts on a student life. We ensure that students achieve their long-cherished goals of studying abroad without any obstacle. Thus we help students to choose the best college/university for them. And we give special attention to our client’s application. We keep up to date information which is essential to submit a well-presented and error-free application. Any student can get admission with our help if he/she meets all the requirements.</p>
              <p></p>
            </div>
            <!-- /column -->
          </div>
      ...
      <div class="wrapper white-wrapper">
        <div class="container inner">
          <h2 class="section-title mb-40 text-center" style=" ">Visa Process</h2>
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <p class="display-4">We help our clients in the entire visa process such as filling up applications, preparing financial statements, providing guidance and training for mock interviews and much more. Students will get every kind of help from us to submit their papers properly to get the visa for their desired country.</p>
              <p></p>
            </div>
            <!-- /column -->
          </div>
      ...
      <div class="wrapper white-wrapper">
        <div class="container inner">
          <h2 class="section-title mb-40 text-center" style=" ">Study to Immigration</h2>
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <p class="display-4">We try to open doors to a lot of immigration program for students. There are a lot of great advantages to becoming an international student in any country. Our Study to Immigration program is designed to help prospective students find the right program, and get started working towards their degree. The degree can contribute to their eligibility to immigrate to that country after their study.</p>
              <p></p>
            </div>
            <!-- /column -->
          </div>
